...
plot_predictions(fit_approval, condition = c("ideology", "education")) +
  labs(
    ...
    subtitle = "Approval generally increases with conservatism; education has smaller, nuanced effects 
    within groups.",
